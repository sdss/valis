...
.. |valis_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('valis')
...
man_pages = [
    (master_doc, 'valis', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/valis'
