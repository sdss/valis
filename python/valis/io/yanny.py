...
# -*- coding: utf-8 -*-
#
# This code is copied from pydl.pydlutils.yanny, version 0.7.0
# to avoid a dependency on the entire pydl package.
#
...
from valis.exceptions import ValisError, ValisUserWarning
    ...
    def append(self, datatable):
        ...
        if len(contents) > 0:
            ...
            if os.access(self.filename, os.W_OK):
                ...
                raise ValisError(self.filename +
                                         " does not exist, aborting append!")
        else:
            warnings.warn("Nothing to be appended!", ValisUserWarning)
        return
...
def read_table_yanny(filename, tablename=None):
    ...
    if tablename is None:
        raise ValisError("The name of the table is required!")
    #
