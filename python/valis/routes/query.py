...
class QueryRoutes(Base):
    ...
    async def get_targets_allspec_id_search(self,
        ...
        fiberid: int  Annotated[str, Query(description="Value of fiberid", example="1")],
        ifudsgn: int  Annotated[str, Query(description="Value of ifudsgn", example="1901")],
        plate: int  Annotated[str, Query(description="Value of plate", example="121")],
        fps_field: int  Annotated[str, Query(description="Value of fps_field", example="15000")],
        plate_or_fps_field: int  Annotated[str, Query(description="Value of plate_or_fps_field", example="266")],
        mjd: int  Annotated[str, Query(description="Value of mjd", example="51578")],
        run2d: str  Annotated[str, Query(description="Value of run2d", example="103")],
        run1d: str  Annotated[str, Query(description="Value of run1d", example="v6_1_3")],
        coadd: str  Annotated[str, Query(description="Value of coadd", example="daily")],
        apred_vers: str  Annotated[str, Query(description="Value of apred_vers", example="dr17")],
        drpver: str  Annotated[str, Query(description="Value of drp_ver", example="v3_1_1")],
        version: str  Annotated[str, Query(description="Value of version", example="103")],
        programname: str  Annotated[str, Query(description="Value of programname", example="apogee")],
        survey: str  Annotated[str, Query(description="Value of survey", example="apogee2")],
        healpix: int  Annotated[str, Query(description="Value of healpix", example="129976")],
        healpixgrp: int  Annotated[str, Query(description="Value of healpixgrp", example="2")],
        apogee_id: str  Annotated[str, Query(description="Value of apogee_id", example="2M12210623+2655354")],
