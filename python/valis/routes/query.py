...
class QueryRoutes(Base):
    ...
    async def get_targets_allspec_id_search(self,
        ...
        sdss_phase: Annotated[int, Query(description="Value of sdss_phase", example="5")],
        observatory: Annotated[str, Query(description="Value of observatory", example="APO")],
        instrument: Annotated[str, Query(description="Value of instrument", example="boss")],
        sdss_id: Annotated[int, Query(description="Value of sdss_id", example="70050164")],
        catalogid: Annotated[int, Query(description="Value of catalogid", example="4375786564")],
        fiberid: Annotated[int, Query(description="Value of fiberid", example="1")],
        ifudsgn: Annotated[int, Query(description="Value of ifudsgn", example="1901")],
        plate: Annotated[int, Query(description="Value of plate", example="121")],
        fps_field: Annotated[int, Query(description="Value of fps_field", example="15000")],
        plate_or_fps_field: Annotated[int, Query(description="Value of plate_or_fps_field", example="266")],
        mjd: Annotated[int, Query(description="Value of mjd", example="51578")],
        run2d: Annotated[str, Query(description="Value of run2d", example="103")],
        run1d: Annotated[str, Query(description="Value of run1d", example="v6_1_3")],
        coadd: Annotated[str, Query(description="Value of coadd", example="daily")],
        apred_vers: Annotated[str, Query(description="Value of apred_vers", example="dr17")],
        drpver: Annotated[str, Query(description="Value of drp_ver", example="v3_1_1")],
        version: Annotated[str, Query(description="Value of version", example="103")],
        programname: Annotated[str, Query(description="Value of programname", example="apogee")],
        survey: Annotated[str, Query(description="Value of survey", example="apogee2")],
        healpix: Annotated[int, Query(description="Value of healpix", example="129976")],
        healpixgrp: Annotated[int, Query(description="Value of healpixgrp", example="2")],
        apogee_id: Annotated[str, Query(description="Value of apogee_id", example="2M12210623+2655354")],
            ):
